...
costfn = torch.load(model_dir + "/bar2/costfn5.pt")
algo = PPO.load(model_dir + "/bar2/bar2_extra_ppo.zip")
...
for _ in range(1):
    ...
    VideoRecorde(imgs1, "expert1.avi", dt)
    VideoRecorde(imgs2, "agent1.avi", dt)