...
if __name__ == "__main__":
    ...
    env = make_env(env_id, num_envs=8, n_steps=600, pltqs=pltqs)

    def feature_fn(x):
        return x

    with open(f"../tmp/log/{env_type}/{algo_type}/{name}/model/044/reward_net.pkl", "rb") as f:
    ...
    for i in range(10):
        algo.learn(total_timesteps=125000, tb_log_name="extra", callback=callback_list)
