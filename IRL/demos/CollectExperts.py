...
def main(actuation=1):
    ...
    with open(f"{proj_path}/IRL/demos/DiscretizedHuman/19171717_done/{subj}_{actuation}.pkl", "rb") as f:
    ...
    save_name = f"{env_type}/19171717_done_quadcost/{subj}_{actuation}.pkl"
