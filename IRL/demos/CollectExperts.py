...
def main(actuation=1):
    ...
    with open(f"{proj_path}/RL/{env_type}/tmp/log/{name}_{subj}_17171719/softqiter/policies_1/agent.pkl", "rb") as f:
    ...
    save_name = f"{env_type}/17171719_quadcost_many/{subj}_{actuation}.pkl"
