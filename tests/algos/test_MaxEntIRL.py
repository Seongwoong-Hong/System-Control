...
@pytest.fixture
def expert(demo_dir):
    expert_dir = os.path.join(demo_dir, "2DWorld", "ppo.pkl")
...
def env(demo_dir):
    ...
    return make_env("2DWorld_disc-v2", subpath=subpath)


@pytest.fixture
def eval_env(demo_dir):
    subpath = os.path.join(demo_dir, "HPC", "sub01", "sub01")
    return make_env("2DWorld_disc-v0", subpath=subpath)
